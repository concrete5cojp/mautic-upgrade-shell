...
# INSTRUCTION:
# ----------
# https://github.com/concrete5cojp/mautic-upgrade-shell
...
WHERE_TO_SAVE="/Users/biplob/Sites/bkup"
WHERE_IS_MAUTIC="/Users/biplob/Sites/mautic"
FILE_NAME="mautic"
...
if [ "$1" = "--all" ] || [ "$1" = "-a" ] || [ "$1" = "" ]; then
    echo "Mautic Backup: You've chosen the ALL option. Now we're backing up all mautic directory files."
...
echo "===================="
echo "Mautic Backup:"
echo "Mautic Backup: Starting mautic backup..."
...
echo "Mautic update: Started..."

echo "Clearing cache..."
php app/console cache:clear

echo "Downloading upgrade.php"
...
# update IP lookup data

echo "Clearing cache..."
php app/console cache:clear

echo "Removing upgrade.php"
rm -f upgrade.php

echo "Mautic Update: Completed!"